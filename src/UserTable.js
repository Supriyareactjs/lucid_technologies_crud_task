        ...
        <>
                            ...
                            Object.keys(filteredUsers).length > 0 ? (
                                filteredUsers.map((user) => (
                                    <TableRow key={user.id}>
                                        ...
                                        <TableCell align='center'><Button onClick={() => handleEdit(user)} className={'editbutton'} sx={{
                                            background: "#1976d2",
                                            color: "#fff", border: "1px solid #1976d2", textTransform: 'capitalize'
                                        }} variant="text"><Create /> Edit  </Button></TableCell>
                                        <TableCell align='center'><Button onClick={() => handleDelete(user.id)} className={'deletebutton'} sx={{
                                            background: "#d32f2f",
                                            color: "#fff", border: "1px solid #d32f2f", textTransform: 'capitalize'
            ...
            <Modal open={editModalOpen} onClose={handleEditModalClose}>
                ...
                >
                    ...
                    }} onClick={handleEditModalClose}><Cancel /></span>
